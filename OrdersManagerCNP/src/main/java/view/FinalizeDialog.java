...
public class FinalizeDialog extends ConfirmationDialog {
    ...
    /**
     * Method used to initialize the reminder panel by adding on top the
     * functionality to handle the reminder computation.
     *
    ...
    /**
     * This method is used to update the total cost of the order accordingly to
     * the current state of the revision board.
     *
     * @param totalCost
     */
