...
public class ChooseSupplementDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			...
			possibleSupplementList.add(new Supplement("Piï¿½ sugo", 1.5f, 0));
			...
			ChooseSupplementDialog dialog = new ChooseSupplementDialog(exampleFrame, new Food("Pasta al ragï¿½", 5f, "", 0), possibleSupplementList);
