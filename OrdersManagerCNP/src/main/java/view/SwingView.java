...
/*		this.supplementList = new ArrayList<Supplement>();
		this.supplementList.add(new Supplement("Piï¿½ Salse", 0.3f, 0l));
		this.supplementList.add(new Supplement("Piï¿½ Condimento", 0.5f, 0l));
...
//		frame.setResizable(false);
		...
		JLabel lblTitleLabel = new JLabel("Gestore prenotazione ordini Codeghì 'N del Pà - Giugno 2013");
